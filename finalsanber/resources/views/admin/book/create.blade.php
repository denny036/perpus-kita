...
<form role="form" action="{{ route('admin.book.store') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="card-body">
        ...
        <div class="form-group @error('title') 'has-error' @enderror">
            ...
            <input type="text" class="form-control" name="title" id="title" value="{{ old('title') }}" placeholder="Masukkan judul Buku..">
        </div>
        ...
        <div class="form-group @error('quantity') 'has-error' @enderror">
            ...
            <input type="text" class="form-control" name="quantity" id="quantity" value="{{ old('quantity') }}" placeholder="Masukkan jumlah buku..">
        </div>
